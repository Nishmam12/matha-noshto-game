...
| 11 | [[Phase 11 - Ship Critical]] | **DONE** — `feat/phase-11-ship-complete` (`8a27404` + shard fix `7cd408a`), 786,432 bytes (+4,608), 653,568 headroom. 5-layer softsynth (deterministic, 0.325 ms worst case), chime/shard/portal SFX, HUD (counters, minimap, toasts, win banner) on the font extended with lowercase, `--hud-test` green, full suite green, `nm` clean of SDL_image/ttf/mixer | — | Audio, font-dependent HUD, save wiring, QA, submission. Not negotiable against the deadline |
