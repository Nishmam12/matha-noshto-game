...
worn paths, ground marks) are DONE there, with their own devlog updates on that branch. This
branch (`feat/phase-08-save-load`, also from `098d232`) therefore does NOT contain the Phase 09
code; merging the two is a later integration step, and they touch disjoint concerns.
